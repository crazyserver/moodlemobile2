...
import { AddonBlockFeedbackComponent } from '../components/feedback/feedback';
 ...
 */
@Injectable()
export class AddonBlockFeedbackHandler extends CoreBlockBaseHandler {
    name = 'AddonBlockFeedback';
    blockName = 'feedback';
    ...
    getDisplayData(injector: Injector, block: any, contextLevel: string, instanceId: number)
        ...
        return {
            title: 'addon.block_feedback.pluginname',
            class: 'addon-block-feedback',
            component: AddonBlockFeedbackComponent
        };
    }
}
